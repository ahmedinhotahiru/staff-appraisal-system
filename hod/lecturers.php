...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Staff Appraisal | Lecturers</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">All lecturers</li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="mb-4">
                                                    ...
                                                    <p class="card-title-desc">FCIS Department.</p>
                                            ...
                                            <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="" href="lecturer-history.php">View <i class="mdi mdi-arrow-right ms-1"></i></a>
                                                        </td>
                                                    </tr>
