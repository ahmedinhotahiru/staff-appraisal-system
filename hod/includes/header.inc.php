                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="../assets/images/logo.png" alt="" height="24"> <span class="logo-txt">HOD</span>
                                </span>
                            </a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-authentication">Lecturers</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="lecturers.php" data-key="t-login">All Lecturers</a></li>
