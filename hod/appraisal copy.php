                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Dr. Peter Agbedenab</h4>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div id="progrss-wizard" class="twitter-bs-wizard">
                                            <ul class="twitter-bs-wizard-nav nav nav-pills nav-justified">
                                                ...
                                                <!-- attitude to work -->
                                                <li class="nav-item">
                                                    <a href="#progress-attitude-to-work" class="nav-link" data-toggle="tab">
                                                        <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Attitude to Work">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#progress-interpersonal-skills" class="nav-link" data-toggle="tab">
                                                        <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Interpersonal Skills, Cooperation, Collaboration">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#progress-testing-and-evaluation" class="nav-link" data-toggle="tab">
                                                        <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Testing and Evaluation">
                                                            <i class="bx bx-book-bookmark"></i>
                                                        </div>
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                ...
                                                <!-- attitude to work -->
                                                <div class="tab-pane" id="progress-attitude-to-work">

                                                    <div class="text-center mb-4">
                                                        <h5>Attitude to Work</h5>
                                                ...
                                                <!-- interpersonal skills -->
                                                <div class="tab-pane" id="progress-interpersonal-skills">
                                                  <div>
                                                    <div class="text-center mb-4">
                                                        <h5>Interpersonal Skills, Cooperation, Collaboration</h5>
                                                        <p class="card-title-desc">Fill all information below</p>
                                                    </div>
                                                ...
                                                <!-- testing and evaluation -->
                                                <div class="tab-pane" id="progress-testing-and-evaluation">
                                                    <div>
                                                        <div class="text-center mb-4">
                                                ...
                                                <!-- administration -->
                                                <div class="tab-pane" id="progress-administration">
                                                    <div>
                                                        <div class="text-center mb-4">
