    ...
    <body>
        ...
        <?php
            ...
            if(!isset($_GET['id']) || empty($_GET['id'])) {
                ...
                // get details
                $id = trim($_GET['id']);
                $department = select_all_where("departments", "department_id", $id);

                if(count($department) > 0) {

                    // get details
                    $department_name = $department[0]["department_name"];
                    $dept_school_faculty_id = $department[0]["school_faculty_id"];
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body"  style="height:400px">
                                        ...
                                        ?>
                                            ...
                                            <form action="controls/edit-department.php"  method="post">
                                                <input type="hidden"/>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            <label>Department Name</label>
                                                            <input type="text" required data-pristine-required-message="Please Enter a Department Name" class="form-control" name="department_name" value="<?php echo $department_name; ?>"/>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <?php
                                                                ...
                                                                if(count($schools_faculties) > 0) {
                                                                    ...
                                                                    foreach ($schools_faculties as $school_faculty) {
                                                                        ...
                                                                        ?>
                                                                        <option value="<?php echo $school_faculty_id; ?>" <?php if($dept_school_faculty_id == $school_faculty_id) {echo 'selected';} ?>><?php echo school_faculty_name($school_faculty_id); ?></option>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" name="edit" class="btn btn-primary">Edit Department</button>
                                                </div>
                                            </form>
                                        </div>
