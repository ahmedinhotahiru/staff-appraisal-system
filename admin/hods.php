                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="mb-4">
                                                    ...
                                                    <p class="card-title-desc">HODs of Departments.</p>
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="d-flex align-items-center gap-1 mb-4">
                                                    <form action="add-staff.php" method="get">
                                                        <button class="input-group-text" type="submit" name="role" value="2"><i class="bx bx-plus"></i> Add New</button>
                                            ...
                                            <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        $hods = select_all_where_desc_id("staff", "role", "HOD", "staff_id");
                                                        ...
                                                        if(count($hods) > 0) {
                                                            ...
                                                            foreach ($hods as $hod) {
                                                                ...
                                                                $staff_id_no = $hod['staff_id_no'];
                                                                $title = $hod['title'];
                                                                $staff_name = $hod['staff_name'];
                                                                $sch_fac_dept_id = $hod['sch_fac_dept_id'];
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="text-danger" onclick="return confirm('Are you sure you want to delete <?php echo $staff_name; ?>?');" href="controls/delete-staff.php?id=<?php echo $staff_id; ?>&role=2">Delete<i class="mdi mdi-delete ms-1"></i></a>
